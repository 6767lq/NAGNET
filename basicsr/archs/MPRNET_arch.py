...
class MPRNet(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=80,up_scale=2, scale_unetfeats=48, scale_orsnetfeats=32, num_cab=8, kernel_size=3,
    ...
    def forward(self, x3_img):
        ...
        # noise = self.noisepredict(x3_img)
        ...
        stage3_img=self.upscale(stage3_img)
        x3_img=self.upscale(x3_img)
        x=stage3_img + x3_img
        # noise2 = self.upconv(noise)
        # target = torch.cat((image, noise2), dim=1)
