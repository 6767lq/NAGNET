...
class GDTD(nn.Module):
    ...
    def __init__(self,
                 ...
                 no_norm,
                 no_mlp,
                 up_scale=2,  # Add up_scale parameter
                 conv=default_conv):
        ...
        self.head1_3 = VisionEncoder(img_dim=patch_size,
                                     patch_dim=patch_dim,
        ...
        self.body1_2 = nn.Sequential(
            VisionEncoder(img_dim=patch_size,
                          patch_dim=patch_dim,
                          num_channels=n_feats,
                          embedding_dim=n_feats * patch_dim * patch_dim,
                          num_heads=num_heads,
        ...
        self.body2_3 = VisionEncoder(img_dim=patch_size,
                                     patch_dim=patch_dim,
                                     num_channels=n_feats,
                                     embedding_dim=n_feats * patch_dim * patch_dim,
                                     num_heads=num_heads,
        ...
        self.body3_3 = VisionEncoder(img_dim=patch_size,
                                     patch_dim=patch_dim,
                                     num_channels=n_feats,
                                     embedding_dim=n_feats * patch_dim * patch_dim,
                                     num_heads=num_heads,
        ...
        self.body3_4 = VisionEncoder(img_dim=patch_size,
                                     patch_dim=patch_dim,
                                     num_channels=n_feats,
                                     embedding_dim=n_feats * patch_dim * patch_dim,
                                     num_heads=num_heads,
