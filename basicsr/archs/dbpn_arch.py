...
class ConvBlock(torch.nn.Module):
    def __init__(self, input_size, output_size, kernel_size=3, stride=1, padding=1, bias=True, activation='prelu',
        ...
        # self.conv = torch.nn.Conv2d(input_size=1,output_size=448, kernel_size=1, stride=1, padding=0, bias=bias)
...
class DBPN_Net(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, scale_factor):
        ...
        # self.output_conv= nn.Conv2d(in_channels=448, out_channels=1, kernel_size=1, stride=1, padding=0, bias=True)
        #
